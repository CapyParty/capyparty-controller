    ...
    ["games/quiplash2"], {
        47214: (t, e, i) => {
            ...
            const m = r().View.extend({
                ...
                onBannerClick() {
                    d.app.analytics.trackEvent("SlideBanner", "SlideBannerClicked", this.getCampaign(), 0), this.model.get("url") && window.open(this.model.get("url"), "_blank")
                },
                onRender() {
                    this.stickit()
                },
                visibleDidChange(t, e) {
                    ...
                    }), .5), e && d.app.analytics.trackEvent("SlideBanner", "SlideBannerOn", this.getCampaign(), 0)
                },
                getCampaign() {
            ...
            const v = r().View.extend({
                ...
                controllerUpdate() {
                    const t = this.model.get("room") || {},
                        e = t.state || "";
                    let i = t.lobbyState;
                    i || -1 === e.indexOf("_") || (i = t.state.split("_")[1]), "PostGame" === i || "Credits" === e || "GameOver" === e || "PostGame" === e || "DayEnd" === e || t.gameResults ? (g.E.isInitialized || g.E.init(this.getOption("appTag")), g.E.show()) : g.E.hide(), d.app.storage && d.app.storage.isSupported && t.platformId && d.app.storage.setTag(`platform-${t.platformId}`)
                },
                update() {
                    return (t = function*() {
                        return null
                ...
                onAttach() {
                    this.update().catch(this.caughtError), a()(".gallery-link").click(this.artifactClicked), d.app.client.isRole("broadcaster") && this.showTwitchBroadcasterDialog(2e4)
                },
                ...
                artifactClicked() {
                    d.app.analytics.trackEvent("PostGame", "galleryClicked", this.getOption("appTag")), p.Q.setAsViewed(0)
                },
                showScreen(t, e) {
                    const i = a()(t);
                                ...
                                if ("GameLocked" !== o) {
                                    if (u && "Lobby" === u) {
                                        ...
                                        if (o && o.success && o.rootId) {
                                            ...
                                            try {
                                                const t = `<a target="_blank" class="gallery-link" href="${s}"><img src="${(yield Promise.resolve().then(i.t.bind(i,218,17))).default}" /></a>`;
                                                e.$el.find("#quiplash2-lobby-postgame").html(t), d.Q.add(o, h.app.client.appTag)
                                            } catch (t) {
