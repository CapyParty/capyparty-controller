(self.webpackChunkjackbox_tv = self.webpackChunkjackbox_tv || []).push([
    [4948], {
        14948: (e, t, s) => {
            ...
            const U = {
                en: {
                    STATUS_GAME_FULL: "Игра полная",
                    STATUS_GAME_STARTED: "Игра началась",
                    STATUS_ROOM_NOT_FOUND: "Комната не найдена",
                    SUBMIT_GAME_FULL: "ИГРА ПОЛНАЯ",
                    SUBMIT_GAME_STARTED: "ИГРА НАЧАЛАСЬ",
                    SUBMIT_JOIN_AUDIENCE: "ЗАЙТИ КАК ЗРИТЕЛЬ",
                    SUBMIT_RECONNECT: "ПЕРЕЗАЙТИ",
                    SUBMIT_TWITCH_LOGIN: "ЗАЙТИ С TWITCH",
                    TOS_WARNING: "Нажав {submit}, вы соглашеетесь с [tos]Правами Использования[/tos] Jackbox Games",
                    LANGUAGE_NAME: "Русский",
                    SUPPORTED_LANGUAGES: ["English", "Français", "Italiano", "Deutsche", "Español"],
                    SUPPORTED_LOCALES: ["en", "fr", "it", "de", "es"],
                    STRING_LOBBY_CENSOR_CONFIRM: "Это удалит имя игрока, аватар, ответы и рисунок. Продолжить?",
                    ...
                    STRING_ERROR_UNABLE_TO_JOIN: "Не можем подключиться к серверам Jackbox Games. В основном это происходит из-за блокировщиков рекламы или дополнений для приватности.",
                    STRING_ERROR_WEBSOCKETS_REQUIRED: "WebSockets не поддерживаются вашим браузером.",
                    ...
                    LANGUAGE: "Язык",
                    LOGIN: "Войти",
                    STRING_CAMERA_WARNING: "[b]ВНИМАНИЕ:[/b] Мы не можем найти вашу камеру, но вы можете играть в игру без фотографии. Если что-то кажется не так, попробуйте зайти с другого браузера.",
                    STRING_STYLE_WARNING: "[b]ВНИМАНИЕ:[/b] Ваш браузер походу устарел, и будет иметь проблемы с отображением игры.",
                    STRING_NAME: "ИМЯ",
                    STRING_NAME_PLACEHOLDER: "ВВЕДИТЕ ВАШЕ ИМЯ",
